...
String FORMATER::GPS_TO_JSON(TinyGsm* modem, String imei, bool debug)
{
  ...
  FORMATER::vGPS(modem,&lat,&lng,&speed,&alt,&gsmlev,&gpslev);
...
// get GPS informations
  ...
  bool FORMATER::vGPS(TinyGsm* modem,String* lat, String *lon, String *speed, String *alt, String *vsat, String *usat) {
    //String buffer = "";
    // char chr_buffer[12];
    bool fix = false;
